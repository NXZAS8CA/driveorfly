...
func formHandler(w http.ResponseWriter, r *http.Request) {
	...
	currentCityLatitude, currentCityLongitude := getCityCoordinations(getCityInformationURL(r.FormValue("currentCity")))
	fmt.Println(currentCityLatitude, currentCityLongitude)
